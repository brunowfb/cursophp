        ...
        <form id="cabecalho" method="post">
            <div style="display: flex; justify-content: center; gap: 10px">
                <div>
                    ...
                    <input style="max-width: 100%;" type="text" name="produto" value="<?php echo htmlspecialchars($produto_editar); ?>">
                </div>
                <div>
                    <label for="editName">Quantidade:</label>
                    <input style="width: 100%;" type="number" name="quantidade" id="quantidade" min="1" value="<?php echo $quantidade_editar; ?>" required>
                </div>
                <div>
                    <label for="editName">Valor unitário:</label>
                    <input style="width: 100%;" type="number" name="preco" id="preco" placeholder="Valor" step="0.01" min="0" value="<?php echo $preco_formatado_para_input; ?>" required>
                </div>
            </div>
            ...
            <div class="modal-content">
                <div style="display:flex;" class="modal-header">
                    <div class="modal-body">
                        <form id="cabecalho-modal" method="post">
                            <input type="hidden" id="itemId" name="index" value="">
                            <div id="cabecalho" style="display: flex; flex-direction:column">
                                <div style="display:flex; justify-content:end;">
                                    <button style="display: flex; width:10%;" type="button" class="btn btn-secondary" data-dismiss="modal">X</button>
                                </div>
                                <div>
